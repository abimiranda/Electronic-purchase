...
# 29 "main.c"
long int Cmil, Ccen, Cdec, Cuni;
long int Amil, Acen, Adec, Auni;
long int Bmil, Bcen, Bdec, Buni;
long int Pmil, Pcen, Pdec, Puni;

long int dolar_hoy=98;

float cobre=10.40, aluminio=5.90, bronce=8.20, plomo=1.30;
long int cobre_hoy, aluminio_hoy, bronce_hoy, plomo_hoy;
long int casosMenu=0;

long int tiempo_ventana_peso=9, activador_tiempo_ventana_peso=0;
long int tiempo_parpadeo_on=1, activador_on=0;
long int tiempo_parpadeo_off=1, activador_off=0;
long int casos_parpadeo=0;

float guarda_ADC, kilos, kgrs_pesado, cen_kg, dec_kg, uni_kg, gramos ;
long int readADC(void);

long int cobrePrecio(void);
long int aluminioPrecio(void);
long int broncePrecio(void);
long int plomoPrecio(void);
...
if(activador_tiempo_ventana_peso==1){
...
long int cobrePrecio(){
cobre_hoy = cobre * dolar_hoy;
return cobre_hoy;
}

long int aluminioPrecio(){
aluminio_hoy = aluminio * dolar_hoy;
return aluminio_hoy;
}

long int broncePrecio(){
bronce_hoy = bronce * dolar_hoy;
return bronce_hoy;
}

long int plomoPrecio(){
...
descomposicion();
if (tiempo_ventana_peso != 0) {
activador_tiempo_ventana_peso = 1;
switch (casos_parpadeo) {
case 0:
{
if (tiempo_parpadeo_on != 0) {
...
if(tiempo_ventana_peso==0){
activador_tiempo_ventana_peso=0;
LATDbits.LD1=0;
LATDbits.LD0=0;
clear_LCD();
casosMenu=4;
